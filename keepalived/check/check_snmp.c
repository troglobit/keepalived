...
static struct variable8 check_vars[] = {
	...
	{CHECK_SNMP_VSSTATSCONNS, ASN_COUNTER, RONLY,
...
#ifdef _KRNL_2_6_
	{CHECK_SNMP_RSSTATSCONNS, ASN_COUNTER, RONLY,
	 check_snmp_realserver, 3, {4, 1, 14}},
	{CHECK_SNMP_RSSTATSACTIVECONNS, ASN_COUNTER, RONLY,
	 check_snmp_realserver, 3, {4, 1, 15}},
	{CHECK_SNMP_RSSTATSINACTIVECONNS, ASN_COUNTER, RONLY,
	 check_snmp_realserver, 3, {4, 1, 16}},
	{CHECK_SNMP_RSSTATSPERSISTENTCONNS, ASN_COUNTER, RONLY,
